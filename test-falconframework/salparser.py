...
class SalParser:
    ...
    def parse_restaurant(self, item):
        ...
        returnRest['comments_streamId'] = 'comments-' + item['PostId']
        returnRest['rtgAmbience_streamId'] = 'ambiente-' + item['PostId']
        returnRest['rtgService_streamId'] = 'servicio-' + item['PostId']
        returnRest['rtgComida_streamId'] = 'comida-' + item['PostId']
        returnRest['post_modified'] = item['post_modified_gmt']
    ...
    def get_rest_food_type(self, id):
        ...
        results = self.db.simple_query(query)
